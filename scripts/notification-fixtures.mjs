...
assert.match(settingsScreen, /<h1>알림<\/h1>/);
...
assert.match(settingsScreen, /notification-off-bell\.svg/);
assert.match(settingsScreen, /받은 알림이 없어요\./);
assert.match(settingsScreen, /알림을 켜고 복용기록을 이어가세요\./);
