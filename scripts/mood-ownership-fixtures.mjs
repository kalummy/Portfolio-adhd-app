...
function mood(date, summary = "categorical summary") {
  return { id: date, date, mood: "good", recordedAt: `${date}T03:00:00.000Z`, memberSummary: summary };
}
...
console.log("PASS repository selection and Mixpanel sensitive-field boundaries");

console.log("mood ownership fixture cases: 9/9 passed");
